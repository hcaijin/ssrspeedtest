...
import getopt
import logging
from shadowsocksr.common import to_bytes, to_str, IPNetwork, PortRange
from shadowsocksr import encrypt
...
def __version():
    ...
    try:
        ...
        version_str = pkg_resources.get_distribution('shadowsocksr').version
    except Exception:
        try:
            from shadowsocksr import version
